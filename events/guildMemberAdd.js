...
${LINESTART} Account Creation: **${member.user.createdAt.toGMTString()}** (${FormatUtil.msToTimeCompact(Date.now() - member.user.createdTimestamp)} ago)`, { disableMentions: 'all' }).catch(()=>{});
}
}